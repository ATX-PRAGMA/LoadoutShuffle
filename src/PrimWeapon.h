...
class PrimWeapon : public Weapon {
	...
	public:
		...
		static const int smg_bounds[] = 0, 5;
		static const int ar_bounds[] = 6, 17;
		static const int sg_bounds[] = 18, 22;
		static const int lmg_bounds[] = 23, 26;
		static const int sr_bounds[] = 27, 31;
